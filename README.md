...
- `npm test`: 6 files, 25 tests passed
- `npm run lint`: passed
- `npm run typecheck`: passed
- `npm run build`: passed
- `npm audit`: 0 vulnerabilities for `v0.4.0`; `v0.4.1` did not change dependencies
- Smoke: `/` 与 `/voice` 浅色模式可读，主题切换可在深色/浅色之间往返
- Playwright smoke: `/` 与 `/voice` 无 console error，关键控件可见
